...
module "cis_waf"{
    ...
    enabled_rulesets = ["Cloudflare Managed Ruleset", "Cloudflare Exposed Credentials Check Ruleset", "Cloudflare OWASP Core Ruleset", "Cloudflare Managed Free Ruleset"]
}
```
